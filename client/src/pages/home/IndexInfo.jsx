        ...
        <div className="container marketing">
          ...
          <div className="row index-wrap">
            ...
            <div className="col-lg-4 index-item">
              <img src={`${process.env.REACT_APP_IMAGE_URI}/home/dashboard.png`} alt="Generic placeholder image"/>
              <h2>Management</h2>
            ...
            <div className="col-lg-4 index-item">
              <img src={`${process.env.REACT_APP_IMAGE_URI}/home/report.png`} alt="Generic placeholder image"/>
              <h2>Report</h2>
            ...
            <div className="col-lg-4 index-item">
              <img src={`${process.env.REACT_APP_IMAGE_URI}/home/subscribe.png`} alt="Generic placeholder image"/>
              <h2>Recomend</h2>
