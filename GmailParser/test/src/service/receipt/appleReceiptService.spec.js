...
import AppleReceiptForm from '../../../../src/model/dto/apple';
...
describe('Apple 영수증 Parser 테스트', () => {
  ...
  describe('영수증 메일 부분, 파싱 확인', () => {
    it('#mailParsing', async () => {
      ...
      const AppleMusicDTO = new AppleReceiptForm();

      try {
        const result = await AppleReceiptParser.metadataParse(AppleMusicJSON, AppleMusicDTO, AppleReceiptParser.iframeParse);
